...
TEST_TAR=assignment-4-tests.tar
ASSIGNMENT_GRADER=https://raw.githubusercontent.com/sfsu-csc-413-fall-2023/grader-interpreter/main/
...
tools: clean
	...
	@javac -d $(COMPILE_DIR) tools/ByteCodeClassGenerator.java
	@java -cp $(COMPILE_DIR) tools.ByteCodeClassGenerator
	@rm -rf $(COMPILE_DIR)
